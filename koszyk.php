...
<table>
    ...
    <tr>
        <td>Smart Glasses</td> <td>99.99 PLN/szt</td> <td><?php echo $produkt1; ?></td>
    </tr>
    <tr>
        <td>Smartbuty</td> <td>217.99 PLN/szt</td> <td><?php echo $produkt2; ?></td>
    </tr>
	<tr>
        <td>Smart Shoes</td> <td>429.99 PLN/szt</td> <td><?php echo $produkt3; ?></td>
    </tr>
    <tr>
        <td>Interactive wall</td> <td>399.99 PLN/szt</td> <td><?php echo $produkt4; ?></td>
    </tr>
	<tr>
        <td>Holographic Projector</td> <td>699.99 PLN/szt</td> <td><?php echo $produkt5; ?></td>
    </tr>
	<tr>
        <td>Electronic Nanny</td> <td>2999.99 PLN/szt</td> <td><?php echo $produkt6; ?></td>
    </tr>
	<tr>
        <td>Watch for Animals</td> <td>349.99 PLN/szt</td> <td><?php echo $produkt7; ?></td>
    </tr>
	<tr>
        <td>Smart Jacket</td> <td>549.99 PLN/szt</td> <td><?php echo $produkt8; ?></td>
    </tr>
	<tr>
        <td>Smart Keyboard</td> <td>199.99 PLN/szt</td> <td><?php echo $produkt9; ?></td>
    </tr>
        <td colspan="9">SUMA</td> <td><?php echo $suma; ?> PLN</td>
    </tr>   
</table>
